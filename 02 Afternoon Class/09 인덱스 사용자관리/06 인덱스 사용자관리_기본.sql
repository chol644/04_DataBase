...
-- a INT PRIMARY KEY, INT UNIQUE, INT UNIQUE, d INT
CREATE TABLE tbl2
(
    a INT PRIMARY KEY,
    b INT UNIQUE,
...
-- a INT UNIQUE, b INT UNIQUE, c INT UNIQUE, d INT
CREATE TABLE tbl3
(
    a INT UNIQUE,
    b INT UNIQUE,
...
-- ALTER를 사용하여 usertbl에서 PRIMARY KEY 제약조건을 제거하고, name 컬럼에 pk_name 이라는 제약조건명으로 기본키를 설정하세요.
ALTER TABLE usertbl
    DROP PRIMARY KEY;
ALTER TABLE usertbl
